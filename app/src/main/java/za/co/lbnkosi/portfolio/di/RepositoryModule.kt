...
object RepositoryModule {
    ...
    @Provides
    fun providesPortfolioRemoteDataSource(portfolioLocalDataSource: LocalPortfolioDataSource, contentLocalDataSource: LocalDynamicContentDataSource, portfolioApiService: PortfolioApiService): PortfolioDataSource = PortfolioDataSource(portfolioLocalDataSource, contentLocalDataSource, portfolioApiService)
